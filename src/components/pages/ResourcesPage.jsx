...
import { BookOpen, Search, ChevronRight, ChevronDown, FileText, HelpCircle, Users, Target, Award, Heart, Microscope, Globe, Mail, CheckCircle, Sparkles } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div id="glossary-section" className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        {filteredTerms.length > 0 ? (
          <>
            <div className={`space-y-8 ${!glossaryExpanded && !searchTerm ? 'max-h-[600px] overflow-hidden relative' : ''}`}>
              ...
              {!glossaryExpanded && !searchTerm && filteredTerms.length > 12 && (
                <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white to-transparent pointer-events-none" />
              )}
            </div>

            {/* Expand/Collapse Button */}
            {!searchTerm && filteredTerms.length > 12 && (
      ...
      {/* FAQs Section */}
      <div id="faqs-section" className="mt-12 bg-white rounded-xl shadow-sm border border-slate-200 p-6">
      ...
      {/* Newsletter Section */}
      <div id="newsletter-section" className="mt-12 bg-gradient-to-br from-purple-600 to-indigo-700 rounded-xl shadow-sm overflow-hidden">
